...
//WIKIPEDIALINK werkt niet https://nl.wikipedia.org/wiki/${keyword} https://en.wikipedia.org/w/api.php?action=query&list=search&prop=summary&inprop=url&utf8=&format=json&origin=*&srlimit=${limit}&srsearch=${keyword}
...
async function searchData(keyword, limit) {
    let response = await fetch(`https://nl.wikipedia.org/wiki/${keyword}`)
